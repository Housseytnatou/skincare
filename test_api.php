...
echo "🧪 Test de l'API des Commandes\n";
echo "================================\n\n";
...
// Test 4: Créer une commande (si on a un token)
if ($token) {
    echo "4. 🛒 Créer une nouvelle commande...\n";
    $orderData = [
    ...
    echo "4. ⚠️ Impossible de créer une commande (pas de token)\n";
}
